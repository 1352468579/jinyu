...
<div id="info-show">
  <ul>
    ...
    <div class="head-face"><a href='<?php echo $spaceurl; ?>'  target="_blank"><img src='<?php echo $mface;?>'/></a></div>
    
    <div class="reply-cont">
    	<p class="username"><a href="<?php echo $spaceurl; ?>" target="_blank"><?php echo $username; ?></a></p>
    	<p class="comment-body"><?php echo ubb($msg); ?></p>
        <p class="comment-footer"><?php echo GetDateMk($dtime); ?>　<span id='goodfb<?php echo $id; ?>'> <a href='#goodfb<?php echo $id; ?>' onclick="postBadGood('goodfb',<?php echo $id; ?>);">赞成</a>[0] </span> <span id='badfb<?php echo $id; ?>'> <a href='#badfb<?php echo $id; ?>' onclick="postBadGood('badfb',<?php echo $id; ?>);">反对</a>[0] </span></p>
    </div>
    </li>
...
<div id="info-show">
  <ul>
    ...
    <div class="reply-cont">
    	<p class="username"><a href="<?php echo $spaceurl; ?>" target="_blank"><?php echo $username; ?></a></p>
    	<p class="comment-body"><?php echo ubb($msg); ?></p>
        <p class="comment-footer"><?php echo GetDateMk($dtime); ?>　<span id='goodfb<?php echo $id; ?>'> <a href='javascript:;' onclick="postBadGood('goodfb',<?php echo $id; ?>);">支持</a>[<?php echo $good; ?>] </span> <span id='badfb<?php echo $id; ?>'> <a href='javascript:;' onclick="postBadGood('badfb',<?php echo $id; ?>);">反对</a>[<?php echo $bad; ?>] </span></p>
    </div>
